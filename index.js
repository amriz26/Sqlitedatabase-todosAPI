...
// GET /todos - retrieve all todo items, optionally filtered by completion status
app.get('/todos', (req, res) => {
    ...
    if (completed === "true" || completed === "false") {
        ...
        params.push(completed === "true" ? 1 : 0); // found that SQLite uses 1 and 0 for boolean values
    }
...
// sstart the server... I'm not sure if this was neededd but I did my research and found about starting servers
app.listen(port, () => {
